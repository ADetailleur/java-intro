...
import exercise_06.WordListAcquirer;
...
public class WebsiteWordListAcquirer implements WordListAcquirer {
  ...
  private String[] unwantedStringParts = new String[]{"\t", "%", "px", "(", ")", "=", ";", "{", "}", "<", ">", "[", "]", "...", "°", "\"", "'", "+", "*", "_", "#", "no-repeat", "solid", "scroll", "function", "type", "bottom", "link", "video", "click", "grab", "node"};
  ...
  private boolean isAcceptable(String word) {
     ...
     for (String unwantedString : unwantedStringParts) {
       if (word.contains(unwantedString)) {
         return false;
       }
     }
